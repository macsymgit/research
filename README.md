# University of Waterloo Program Research
...
| [Architecture vs. Architectural Engineering Comparison](waterloo-arch-comparison.md) | Side-by-side comparison: admission, curriculum, salary trajectories, ROI, 12-factor decision matrix |
...
| [Architecture vs. Health Sciences Comparison](architecture-vs-health-sciences.md) | Cross-discipline comparison of Architecture and Health Sciences programs |
...
| [建筑学 vs. 建筑工程对比](waterloo-arch-comparison-zh.md) | 两个建筑相关专业对比中文版 |
