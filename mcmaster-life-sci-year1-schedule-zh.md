# 麦马士特大学 生命科学 — 一年级选课计划（2026–27 学年）

**制定日期：** 2026-05-11
**更新日期：** 2026-06-24 — 对照**官方 Life Sciences Gateway 课程清单**与学生在 **Mosaic 的实际选课**重新核对。
**用途：** 麦马士特大学 Life Sciences Gateway（一级入门门户）一年级个人选课方案，含改动理由与核对清单。
**参考文档：** [`mcmaster-life-sciences.md`](mcmaster-life-sciences.md)、[`mcmaster-life-vs-western-medical-sciences.md`](mcmaster-life-vs-western-medical-sciences.md)
...
| 学期 | 课程 | 学分 | 类型 | 备注 |
|---|---|---|---|---|
| **秋季** | BIOLOGY 1A03 — 细胞与分子生物学 | 3 | Gateway 核心 | ✅ 已选 |
| 秋季 | CHEM 1A03 — 普通化学 I | 3 | Gateway 核心 | ✅ 已选 — 一年级 GPA 风险最高的课 |
| 秋季 | MATH 1LS3 — 生命科学微积分 I | 3 | Gateway 核心 | ✅ 已选 |
| 秋季 | **PSYCH 1X03 — 心理学、神经科学与行为学导论 I** ⬅ **新增** | 3 | Gateway 核心 | MCAT 心理/社会部分备考；官方 Gateway 清单中的必修课 |
| 秋季 | **ASTRON 1F03 — 天文学导论** ⬅ **新增** | 3 | 选修 | GPA 友好的客观考试型课，保护你最难的一个学期 |
| 秋季 | BIOSAFE 1BS0 — 生物安全培训 | 0 | 强制 | ✅ 已选 |
| 秋季 | WHMIS 1A00 — 健康与安全 | 0 | 强制 | ✅ 已选 |
...
> **数学说明：** Gateway 只要求 **MATH 1LS3**，所以这份 30 学分方案本身已经成立。*如果你的二级目标专业要求 **MATH 1LS3 + 1LT3** 配对（如 Biology、Biochemistry、数学较重的 Pharmacology 方向），就把冬季选修 **PSYCH 1XX3 → MATH 1LT3** 替换。* 否则 MATH 1LT3 放到二年级再修。

---

## 与你在 Mosaic 实际选课的对比

你当前在 Mosaic 的选课**只有 18 学分（6 门学术课程）**，恰好是**半个课负荷**。标准一年级满课负荷是 **30 学分（15 + 15）**。
...
### 在 Mosaic 里核对 — 秋季周四可能的冲突
- [ ] BIO 1A03 的 **Lab（周四 1:30–4:20，BSB 217）** 和 **Tutorial（周四 1:30–2:20，BSB B139）** 都从周四 1:30 PM 开始。这两个通常是**隔周轮流**上课，所以系统才允许同时选——但请打开日历视图，确认没有哪一周真的撞在一起。

### 学年期间
- [ ] **一年级 GPA 目标：3.85 以上（11.0+/12.0）** — 保住所有二级专业选项，含 BHSc 二级转专业。
- [ ] CHEM 1A03 和 MATH 1LS3 的前 4 周必须去 office hours — 这两门是一年级"淘汰课"。
- [ ] **每个学期**都跟踪学期 GPA，不要只看学年末。一旦低于 3.7，立刻调整。
- [ ] 一年级不要承担重课外活动（参见 `mcmaster-life-sciences.md:688`），一个社团 + 轻量义工就足够。
...
- **MATH 1LT3** — Gateway 不要求；只有当某个具体二级目标需要微积分配对时才加（那就加上）。否则二年级再修。
- **看起来"高大上"的选修课** — 进二级专业靠 GPA；选课履历只在边际起作用。
- **Co-op 决策** — 生命科学 Co-op 申请在二年级/三年级，不是一年级。
- **二级专业的具体选修课**（Origins of Disease 等）— 那些是二级声明的事；一年级只要把上面这张课表的先修课打通就够了。
...
**本仓库内的锚定研究：**
- [`mcmaster-life-sciences.md`](mcmaster-life-sciences.md) — 麦马士特生命科学完整研究报告（二级结构、BHSc 转专业、GPA 风险、医学预科路径）
- [`mcmaster-life-vs-western-medical-sciences.md`](mcmaster-life-vs-western-medical-sciences.md) — 对比参考

**麦马士特官方（2026-06-24 核实）：**
- [Life Sciences Gateway — MAPSci](https://mapsci.ca/level-1-programs/gateway-programs/life-science-gateway/) — 官方 8 门核心 + 6 学分选修，含 PHYSICS 1A03、PSYCH 1X03、ENVIRSC 1C03
- [Life Sciences Gateway — Future Students](https://future.mcmaster.ca/programs/lifesci/)
- [二级专业选拔 — 理学院](https://undergraduate.science.mcmaster.ca/current-students/enrollment-information/level-2-program-selection/)
- [OSAP 课负荷计算器 — 注册办公室](https://registrar.mcmaster.ca/course-load-calculator/)（30 学分 = 标准满课负荷）
- [一级学生可选选修课 — 学术日历](https://academiccalendars.romcmaster.ca/preview_program.php?catoid=53&poid=27061)
- [Simple Syllabus 教学大纲库](https://mcmaster.simplesyllabus.com/en-US/syllabus-library?organization_id=14a8f24e-1bbf-4019-b406-3afd709608da)

**学生社区（仅供方向性参考，须对照当前教学大纲核实）：**
- [一年级生命科学选什么选修课 — MacInsiders](https://macinsiders.com/showthread.php/electives-take-first-year-life-sciences-60471.html)
- [Rate My Courses — 麦马目录](https://www.ratemycourses.io/mcmaster)
